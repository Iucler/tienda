        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:info@company.com">tito-nueve@hotmail.es</a>
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <?php if (!empty($_SESSION['correoCliente'])) { ?>
                        <a class="nav-icon position-relative text-decoration-none" href="<?php echo BASE_URL . 'clientes' ?>">
                            <img class="img-thumbnail" src="<?php BASE_URL . 'assets/img/clientes/default.png'; ?>" alt="LOGO CLIENTE" width="50px">
                        </a>
                    <?php } else { ?>
