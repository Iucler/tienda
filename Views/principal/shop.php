            ...
            <div div="row">
                <ul class="pagination pagination-lg justify-content-end">
                    ...
                    if ($data['pagina'] > 1) {
                        ...
                        <a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="' . BASE_URL . "principal/shop/" . $anterior . '">Anterior</a>
                    </li>';
                    }
                    if ($data['total'] >= $siguiente)
                        echo '<li class="page-item">
                    <a class="page-link  active rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" href="' . BASE_URL . "principal/shop/" . $siguiente . '">Siguiente</a>
                </li>';
                    ?>
                </ul>
            </div>
...
<<?php include_once 'Views/template-principal/footer.php'; ?> </body>
